...
--
-- Host: localhost    Database: friend_book
-- ------------------------------------------------------
...
CREATE TABLE `comments` (
  ...
  KEY `idex_post_id` (`comment_post_id`),
  KEY `idex_answer` (`comment_answer`),
  CONSTRAINT `comment_to_post` FOREIGN KEY (`comment_post_id`) REFERENCES `posts` (`post_id`),
...
-- Dump completed on 2018-05-13 23:36:10
